...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, use_ws=True, num_classes=1000, block_name='BasicBlock'):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.layer1 = self._make_layer(block, 16, n, use_ws)
        self.layer2 = self._make_layer(block, 32, n, use_ws, stride=2)
        self.layer3 = self._make_layer(block, 64, n, use_ws, stride=2)
